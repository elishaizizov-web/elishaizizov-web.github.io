...
const T = {
  de: {
    ...
    sl: 'Karriere',
    y1: 'Ab 2024 · Frankfurt am Main', s1h: 'Rabbiner, Bait Sfaradi', s1d: 'Ernannt zum Rabbiner von Bait Sfaradi Frankfurt am Main',
    y2: 'Ab Ende 2023 · Frankfurt am Main', s2h: 'Rabbiner', s2d: 'Jugend, Gymnasium und Gemeindearbeit',
    y3: '2020–2023 · Basel', s3h: 'Rabbiner & Vortragsredner', s3d: 'Schomre Tora Institut Basel',
    y4: 'Ordination · Alter 24', s4h: 'Rabbinatsordination', s4d: 'Talmud, Halacha und jüdisches Denken',
  ...
  en: {
    ...
    sl: 'Career',
    y1: 'From 2024 · Frankfurt am Main', s1h: 'Rabbi, Bait Sfaradi', s1d: 'Appointed Rabbi of Bait Sfaradi Frankfurt am Main',
    y2: 'Since late 2023 · Frankfurt am Main', s2h: 'Rabbi', s2d: 'Youth, Gymnasium and Community Work',
    y3: '2020–2023 · Basel', s3h: 'Rabbi & Lecturer', s3d: 'Schomre Tora Institut Basel',
    y4: 'Ordination · Age 24', s4h: 'Rabbinical Ordination', s4d: 'Talmud, Halacha and Jewish Thought',
    ig: 'Instagram', fb: 'Facebook',
  ...
  fr: {
    ...
    sl: 'Carrière',
    y1: 'Dès 2024 · Francfort-sur-le-Main', s1h: 'Rabbin, Bait Sfaradi', s1d: 'Nommé rabbin de Bait Sfaradi Francfort-sur-le-Main',
    y2: 'Depuis fin 2023 · Francfort-sur-le-Main', s2h: 'Rabbin', s2d: 'Jeunesse, lycée et vie communautaire',
    y3: '2020–2023 · Bâle', s3h: 'Rabbin & Conférencier', s3d: 'Schomre Tora Bâle',
    y4: 'Ordination · 24 ans', s4h: 'Ordination rabbinique', s4d: 'Talmud, Halacha et pensée juive',
    ig: 'Instagram', fb: 'Facebook',
  ...
  he: {
    ...
    sl: 'קריירה',
    y1: 'משנת 2024 · פרנקפורט', s1h: 'רב, בית ספרדי', s1d: 'מונה לרב של בית ספרדי פרנקפורט',
    y2: 'מסוף 2023 · פרנקפורט', s2h: 'רב', s2d: 'נוער, גימנסיה ועבודה קהילתית',
    y3: '2020–2023 · באזל', s3h: 'רב ומרצה', s3d: 'מכון שומרי תורה באזל',
    y4: 'הסמכה · גיל 24', s4h: 'הסמכה לרבנות', s4d: 'תלמוד, הלכה ומחשבת ישראל',
    ig: 'Instagram', fb: 'Facebook',
  ...
  es: {
    ...
    sl: 'Carrera',
    y1: 'Desde 2024 · Fráncfort del Meno', s1h: 'Rabino, Bait Sfaradi', s1d: 'Nombrado Rabino de Bait Sfaradi Fráncfort del Meno',
    y2: 'Desde finales de 2023 · Fráncfort del Meno', s2h: 'Rabino', s2d: 'Juventud, gimnasio y vida comunitaria',
    y3: '2020–2023 · Basilea', s3h: 'Rabino & Conferencista', s3d: 'Schomre Tora Institut Basel',
    y4: 'Ordination · 24 años', s4h: 'Ordenación rabínica', s4d: 'Talmud, Halacha y pensamiento judío',
    ig: 'Instagram', fb: 'Facebook',
  ...
  ru: {
    ...
    sl: 'Карьера',
    y1: 'С 2024 · Франкфурт-на-Майне', s1h: 'Раввин, Бейт Сфаради', s1d: 'Назначен раввином Бейт Сфаради Франкфурт',
    y2: 'С конца 2023 · Франкфурт-на-Майне', s2h: 'Раввин', s2d: 'Молодёжь, гимназия и общинная работа',
    y3: '2020–2023 · Базель', s3h: 'Раввин и лектор', s3d: 'Schomre Tora Базель',
    y4: 'Ordination · 24 года', s4h: 'Раввинская ординация', s4d: 'Талмуд, Halacha и еврейская мысль',
    ig: 'Instagram', fb: 'Facebook',
